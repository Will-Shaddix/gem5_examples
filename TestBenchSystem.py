...
class TestBenchSystem(System):
    ...
    def __init__(self, options):
        ...
        elif options.mem_type == 'DDR':
            self._mem_type = DDR3_1600_8x8
            self._addr_mapping = DDR3_1600_8x8.addr_mapping
            self._paging_policy = DDR3_1600_8x8.page_policy
        else:
    ...
    def createMemoryCtrl(self):
        ...
        elif self._mem_type == DDR3_1600_8x8:
            num_chnls = self._num_chnls
        else:
            fatal('Memory type not supported.')
